...
export const seoPages = {
  ...
  brandIntro: page({
    ...
    description:
      "고덕 수자인 하우스디의 브랜드 가치와 주거 철학을 소개합니다. 평택 고덕국제화계획지구 생활권에서 누리는 프리미엄 주거 가치를 확인하세요.",
    menu: "브랜드소개",
  }),
  brandVideo: page({
    path: "/Brand/video",
    ...
    description:
      "고덕 수자인 하우스디 홍보영상을 통해 평택 고덕국제화계획지구 A-67BL 입지와 브랜드 프리미엄, 단지의 주거 가치를 확인하세요.",
    menu: "브랜드소개",
  }),
  businessIntro: page({
    path: "/BusinessGuide/intro",
    ...
    description:
      "고덕 수자인 하우스디 사업개요 안내입니다. 평택 고덕국제화계획지구 A-67BL, 총 403세대, 전용 84㎡와 101㎡ 중심의 브랜드 아파트 정보를 확인하세요.",
    menu: "사업개요",
  ...
  businessPlan: page({
    ...
    description:
      "고덕 수자인 하우스디 분양일정 안내입니다. 특별공급, 일반공급, 당첨자 발표, 서류접수와 정당계약 등 주요 청약 일정을 확인하세요.",
    menu: "사업개요",
  }),
  salesGuide: page({
    path: "/BusinessGuide/documents",
    ...
    description:
      "고덕 수자인 하우스디 공급안내 페이지입니다. 타입별 공급 구성, 모집공고, 분양 조건과 청약 전 확인해야 할 주요 정보를 안내합니다.",
    menu: "분양안내",
  }),
  salesInfoGuide: page({
    ...
    description:
      "고덕 수자인 하우스디 분양안내 페이지입니다. 공급 정보, 청약 절차, 분양 일정과 계약 관련 주요 안내를 한눈에 확인하세요.",
    menu: "분양안내",
  }),
  subscriptionGuide: page({
    ...
    description:
      "고덕 수자인 하우스디 청약안내입니다. 특별공급과 일반공급 신청 전 확인해야 할 청약 자격, 접수 절차, 당첨자 발표 정보를 안내합니다.",
    menu: "분양안내",
  }),
  announcement: page({
    ...
    description:
      "고덕 수자인 하우스디 모집공고안내 페이지입니다. 공급 세대, 청약 일정, 계약 조건 등 분양 전 반드시 확인해야 할 공고 정보를 제공합니다.",
    menu: "분양안내",
  }),
  stampTax: page({
    ...
    description:
      "고덕 수자인 하우스디 인지세 납부안내입니다. 분양계약 시 필요한 인지세 납부 기준과 계약 관련 유의사항을 확인하세요.",
    menu: "분양안내",
  }),
  locationIntro: page({
    path: "/LocationEnvironment/intro",
    ...
    description:
      "고덕 수자인 하우스디 입지환경 안내입니다. 삼성 평택캠퍼스 직주근접, 고덕국제화계획지구 생활권, 교통·교육·생활 인프라와 미래가치를 확인하세요.",
    menu: "입지환경",
  ...
  locationPremium: page({
    ...
    description:
      "고덕 수자인 하우스디 프리미엄 안내입니다. 고덕국제화계획지구 중심 생활권, 직주근접 입지, 미래가치와 브랜드 주거 가치를 소개합니다.",
    menu: "입지환경",
    image: "/img/og/location.jpg",
  }),
  complexIntro: page({
    ...
    description:
      "고덕 수자인 하우스디 단지 배치도 안내입니다. 동선, 조망, 생활 편의와 쾌적성을 고려한 단지 구성과 배치 계획을 확인하세요.",
    menu: "단지안내",
  ...
  complexDetail: page({
    ...
    description:
      "고덕 수자인 하우스디 호수 배치도 안내입니다. 동·호수 구성과 단지 내 위치 정보를 통해 세대별 배치 흐름을 확인하세요.",
    menu: "단지안내",
    image: "/img/og/complex.jpg",
  }),
  complexCommunity: page({
    ...
    description:
      "고덕 수자인 하우스디 커뮤니티 안내입니다. 입주민의 일상 편의와 여가를 고려한 커뮤니티 시설과 단지 생활 가치를 확인하세요.",
    menu: "단지안내",
    image: "/img/og/complex.jpg",
  }),
  floorPlan84A: page({
    ...
    description:
      "고덕 수자인 하우스디 84A㎡ 평면도 안내입니다. 실거주 선호도가 높은 대표 타입의 공간 구성과 생활 동선을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan84C: page({
    path: "/FloorPlan/59B",
    ...
    description:
      "고덕 수자인 하우스디 84C㎡ 평면도 안내입니다. 공간 활용과 수납, 가족 생활 동선을 고려한 세대 구성을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan101: page({
    path: "/FloorPlan/84A",
    ...
    description:
      "고덕 수자인 하우스디 101㎡ 평면도 안내입니다. 여유로운 중대형 타입의 공간감과 실내 구성을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan84B: page({
    path: "/FloorPlan/84B",
    ...
    description:
      "고덕 수자인 하우스디 84B㎡ 평면도 안내입니다. 타입별 세대 구성과 공간 활용 포인트를 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan114A: page({
    path: "/FloorPlan/114A",
    title: "114A㎡ 평면도 | 고덕 수자인 하우스디",
    description:
      "고덕 수자인 하우스디 114A㎡ 평면도 안내입니다. 넉넉한 공간 구성과 타입별 특화 요소를 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan114B: page({
    path: "/FloorPlan/114B",
    title: "114B㎡ 평면도 | 고덕 수자인 하우스디",
    description:
      "고덕 수자인 하우스디 114B㎡ 평면도 안내입니다. 가족 중심 생활에 맞춘 공간 구성과 동선을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlanVideos: page({
    ...
    description:
      "고덕 수자인 하우스디 세대안내영상 페이지입니다. 타입별 공간 구성과 실내 포인트를 영상으로 확인하세요.",
    menu: "세대안내",
  }),
  emodel: page({
    ...
    description:
      "고덕 수자인 하우스디 E-모델하우스입니다. 84A㎡, 84C㎡, 101㎡ 타입의 실내 구조, 공간 구성과 주거 동선을 온라인으로 확인하세요.",
    menu: "세대안내",
  ...
  interior84A: page({
    ...
    description:
      "고덕 수자인 하우스디 84A㎡ 인테리어 안내입니다. 실내 마감, 공간 분위기와 타입별 인테리어 포인트를 확인하세요.",
    menu: "인테리어",
  }),
  interior84C: page({
    path: "/Interior/84A",
    ...
    description:
      "고덕 수자인 하우스디 84C㎡ 인테리어 안내입니다. 타입별 실내 분위기와 공간 활용 포인트를 확인하세요.",
    menu: "인테리어",
  }),
  interior101: page({
    path: "/Interior/84B",
    ...
    description:
      "고덕 수자인 하우스디 101㎡ 인테리어 안내입니다. 여유로운 실내 공간과 마감 포인트를 확인하세요.",
    menu: "인테리어",
  }),
  press: page({
    ...
    description:
      "고덕 수자인 하우스디 언론보도 페이지입니다. 분양 소식, 사업 안내와 최신 홍보센터 정보를 확인하세요.",
    menu: "홍보센터",
    priority: 0.7,
  }),
  customer: page({
    ...
    description:
      "고덕 수자인 하우스디 관심고객등록 페이지입니다. 분양 일정, 모델하우스 방문예약, 청약 정보와 주요 안내를 빠르게 받아보세요.",
    menu: "홍보센터",

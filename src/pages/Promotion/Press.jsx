...
export default function Press() {
  ...
  const seoPage = useMemo(
    () => ({
      ...
      description:
        "고덕 수자인 하우스디 언론보도 페이지입니다. 평택 고덕국제화계획지구 A-67BL 공급 정보, 청약, 입지환경, 모델하우스 방문예약 관련 공식 보도자료와 분양 소식을 확인하세요.",
      extraSchemas: [
        {
          "@context": "https://schema.org",
          "@type": "ItemList",
          "@id": `${getAbsoluteUrl(pressBasePath)}#press-list`,
          name: "고덕 수자인 하우스디 언론보도 목록",
        ...
        <section className={styles.pressHero} aria-labelledby="pressTitle">
          <div>
            ...
            <p className={styles.pressLead}>
              평택 고덕국제화계획지구 A-67BL 공급 정보부터 청약, 입지환경,
              모델하우스 방문예약까지 고덕 수자인 하우스디의 공식 보도자료와
              분양 소식을 전합니다.
            </p>
          ...
          <div className={styles.pressStats} aria-label="고덕 수자인 하우스디 주요 정보">
            <div>
